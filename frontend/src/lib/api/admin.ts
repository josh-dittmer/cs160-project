...
export async function updateEmployeeManager(
  ...
  const response = await fetch(
    `${API_BASE_URL}/api/admin/users/${userId}/manager`,
    {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${token}`,
...
export async function listItems(
  ...
  const url = `${API_BASE_URL}/api/admin/items${
...
export async function activateItem(
  ...
  const response = await fetch(
    `${API_BASE_URL}/api/admin/items/${itemId}/activate`,
    {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${token}`,
...
export async function permanentlyDeleteItem(
  ...
  const response = await fetch(
    `${API_BASE_URL}/api/admin/items/${itemId}/permanent`,
    {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
...
export async function generateVideoSync(
  ...
  const response = await fetch(
    `${API_BASE_URL}/api/admin/video/generate-sync`,
    {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
...
export async function checkVideoStatus(
  ...
  const response = await fetch(
    `${API_BASE_URL}/api/admin/video/status/${operationId}`,
    {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
...
export async function deleteVideoOperation(
  ...
  const response = await fetch(
    `${API_BASE_URL}/api/admin/video/operation/${operationId}`,
    {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
...
export async function listAuditLogs(
  ...
  const url = `${API_BASE_URL}/api/admin/audit-logs${
...
export async function managerUpdateUserRole(
  ...
  const response = await fetch(
    `${API_BASE_URL}/api/manager/users/${userId}/role`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export async function managerBlockUser(
  ...
  const response = await fetch(
    `${API_BASE_URL}/api/manager/users/${userId}/block`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
