        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredItems.map((item) => (
                    <div
                        key={item.id}
                        className={`bg-white rounded-lg shadow overflow-hidden ${!item.is_active ? 'opacity-60' : ''
                            }`}
                    >
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pr-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900 ${formData.price_usd ? 'pl-7' : 'pl-3'
                                            }`}
                                    />
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2 mb-3">
                                <button
                                    ...
                                    className={`flex-1 px-4 py-2 rounded-md text-sm font-medium transition-colors ${imageUploadMode === 'upload'
                                ...
                                <button
                                    ...
                                    className={`flex-1 px-4 py-2 rounded-md text-sm font-medium transition-colors ${imageUploadMode === 'ai'
                                        ? 'bg-blue-600 text-white'
                                        : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                        }`}
                                >
                            ...
                            {showNutritionSection && (
                                <div className="p-4 border-t border-gray-200">
                                    <textarea
                                        ...
                                        className={`w-full px-3 py-2 border rounded-md bg-white text-gray-900 font-mono text-sm ${nutritionJsonError ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300'
                                            }`}
                                    />
                                    {nutritionJsonError ? (
                                ...
                                <div className="p-4 border-t border-gray-200 space-y-4">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className={`flex-1 px-3 py-2 text-sm font-medium rounded-md transition-colors ${videoMethod === 'url'
                                                ? 'bg-blue-600 text-white'
                                                : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                                }`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`flex-1 px-3 py-2 text-sm font-medium rounded-md transition-colors ${videoMethod === 'upload'
                                                ? 'bg-blue-600 text-white'
                                                : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                                }`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`flex-1 px-3 py-2 text-sm font-medium rounded-md transition-colors ${videoMethod === 'ai'
                                                ? 'bg-blue-600 text-white'
                                                : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                                }`}
                                        >
